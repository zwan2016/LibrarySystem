...
//show books for admin to choose to lend it to the user we choosed before
...
<head>
    ...
    <script type="text/javascript">
		...
		function lend(btn){
			//del_ff(btn);
			ISBN=btn.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;
			uid=<?php echo $uid?>;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            search books for <?php echo $username ?>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody id="tbody">
									...
									while($row = mysql_fetch_array($data)){
                                        ...
                                        echo"<td><button class=\"btn btn-warning btn-sm\" onclick=\"lend(this)\">
                                        Lend
                                    </button></td>";
										echo"</tr>";
									}
