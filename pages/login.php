...
if(!isset($_SESSION['email'])){
	//session['email']['name'] store the email of the user
    //session['email']['admin'] store the identity of the user, 1 means admin, 0 means normal user 
...
<head>
    ...
    <title>Edward Libaray - Login</title>
